...
st.text('')
if run==1:
	model= torch.hub.load(r'D:\YOLO-Flask\yolov5','custom',path='yolov5/runs/train/exp25/weights/best.pt',source = 'local', force_reload=True)
...
if run1==1:
	model= torch.hub.load(r'D:\YOLO-Flask\yolov5','custom',path='yolov5/runs/train/exp15/weights/last.pt',source = 'local', force_reload=True)
	...
	cv2.destroyAllWindows()
if run2==1:
	model= torch.hub.load(r'D:\YOLO-Flask\yolov5','custom',path='yolov5/runs/train/exp28/weights/best.pt', source = 'local', force_reload=True)
